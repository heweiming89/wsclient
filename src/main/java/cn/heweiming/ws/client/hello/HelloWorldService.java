 ...
 * 
 */
@WebServiceClient(name = "HelloWorldService", targetNamespace = "http://server.ws.heweiming.cn/", wsdlLocation = "http://192.168.0.101/helloWorld?WSDL")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDSERVICE_QNAME = new QName("http://server.ws.heweiming.cn/", "HelloWorldService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://192.168.0.101/helloWorld?WSDL");
    ...
    public HelloWorld getHelloWorldPort() {
        return super.getPort(new QName("http://server.ws.heweiming.cn/", "HelloWorldPort"), HelloWorld.class);
    }
    ...
    public HelloWorld getHelloWorldPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server.ws.heweiming.cn/", "HelloWorldPort"), HelloWorld.class, features);
    }
